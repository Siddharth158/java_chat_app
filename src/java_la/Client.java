...
public class Client implements ActionListener {
    ...
    Client(){
        ...
        //profile image
        ImageIcon img3 = new ImageIcon("C:\\Users\\siddh\\java_la\\java_la\\src\\java_la\\2.png");
        ...
        //adding names
        JLabel name = new JLabel("reciever");
...
//        Calendar date = Calendar.getInstance();
    ...
    public static void main(String[] args) {
        ...
        try{
            Socket s = new Socket("192.168.137.1",6001);
